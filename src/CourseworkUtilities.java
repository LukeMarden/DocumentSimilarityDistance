...
//    }
    ...
    public String[] generateDictionary(int numWords, int wordLength){
...
//        }
    ...
    public String[] generateFillerWords(int numWords, int wordLength){
    ...
    public String[] generateDocument(String[] dictionary, int numWordsInDoc){
